...
"""
    ...
    b'fa7cc8a2b0a932f8e6ea42f9787e9d36e592e0c222ada6a9'
...
def pbkdf2_hex(data, salt, iterations=1000, key_len=24, hash_func=None):
    """Like :func:`pbkdf2_bin` but returns a hex encoded string."""
    return binascii.hexlify(pbkdf2_bin(data.encode('utf-8'), salt.encode('utf-8'), iterations, keylen, hash_func))
