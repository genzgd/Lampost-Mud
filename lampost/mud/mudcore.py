...
from lampost.context.resource import m_requires, requires, register_module
from lampost.env.movement import Direction
from lampost.env.room import Room, safe_room
from lampost.mud.action import mud_action, imm_actions

m_requires(__name__, 'log', 'datastore', 'dispatcher', 'perm', 'user_manager', 'session_manager',
           'message_service', 'friend_service', 'dispatcher')
